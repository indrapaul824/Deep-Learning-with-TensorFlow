    var isMobile =
      ...
      if (isMobile) {
        $("#paint").css({ width: "60%" });
        $("#number").css({ width: "30%", "font-size": "120px" });
        $("#clear").css({ "font-size": "50px" });
      } else {
        $("#paint").css({ width: "200px" });
      ...
      canvas.addEventListener(
        ...
        function () {
          //   $("#number").html(
          // '<img id="spinner" src="https://raw.githubusercontent.com/carlos-aguayo/carlos-aguayo.github.io/master/spinner.gif"/>'
          //   );
